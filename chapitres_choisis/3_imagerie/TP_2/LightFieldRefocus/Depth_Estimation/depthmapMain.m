...
prefix = ".\Sample_Data\DepthEstimation_Output\depthMap_";
suffix = ".png";
...
for f = 1:frameLen
    ...
    lightFieldGray = genLfSequenceGray(".\Sample_Data\DepthEstimation_Input\", "Painter_pr_00",views,frameOfInterest,'png');
...
save(".\Sample_Data\DepthEstimation_Output\depthMaps59.mat",'depthMapMat','-v7.3');
